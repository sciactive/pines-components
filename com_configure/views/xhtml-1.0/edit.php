...
<form id="p_muid_form" class="pf-form" action="<?php echo htmlentities(pines_url('com_configure', 'save')); ?>" method="post">
	...
	<div class="pf-element pf-full-width">
		<label><span class="pf-label"><input class="p_muid_default_checkbox" type="checkbox" name="manset_<?php echo htmlentities($cur_var['name']); ?>" value="ON" <?php echo $is_default ? '' : 'checked="checked" '; ?>/> <?php echo htmlentities($cur_var['cname']); ?></span></label>
		...
		<div class="setting" style="display: none;">
			...
			<?php } else { ?>
				...
				<input class="pf-field" type="checkbox" name="opt_bool_<?php echo htmlentities($cur_var['name']); ?>" value="ON" <?php echo ($cur_value ? 'checked="checked" ' : ''); ?>/>
