...
<form class="pf-form" method="post" id="p_muid_form" action="<?php echo htmlspecialchars(pines_url('com_customer', 'company/save')); ?>">
	...
	<div class="pf-element">
		<label><span class="pf-label">Website</span>
			...
			<input class="pf-field" type="url" name="website" size="24" value="<?php echo htmlspecialchars($this->entity->website); ?>" /></label>
	</div>
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button btn" type="button" onclick="pines.get(<?php echo htmlspecialchars(json_encode(pines_url('com_customer', 'company/list'))); ?>);" value="Cancel" />
	</div>
</form>