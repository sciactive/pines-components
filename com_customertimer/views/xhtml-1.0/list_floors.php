	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'New', extra_class: 'icon picon_16x16_document-new', selection_optional: true, url: '<?php echo pines_url('com_customertimer', 'editfloor'); ?>'},
				<?php } if (gatekeeper('com_customertimer/editfloor')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'icon picon_16x16_document-open', url: '<?php echo pines_url('com_customertimer', 'editfloor', array('id' => '__title__')); ?>'},
				<?php } if (gatekeeper('com_customertimer/timefloor')) { ?>
				{type: 'button', text: 'Timer', extra_class: 'icon picon_16x16_stock_timer', double_click: true, url: '<?php echo pines_url('com_customertimer', 'timefloor', array('id' => '__title__')); ?>'},
				<?php } ?>
				...
				{type: 'button', text: 'Delete', extra_class: 'icon picon_16x16_edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_customertimer', 'deletefloor', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
				<?php } ?>
