	...
	$.Elastislide.prototype = {
		...
		_addTransition : function() {
			...
			if( this.support ) {
				...
				this.$el.css( '-webkit-transition', 'all ' + this.options.speed + 'ms ' + this.options.easing );
				this.$el.css( '-moz-transition', 'all ' + this.options.speed + 'ms ' + this.options.easing );
				this.$el.css( '-o-transition', 'all ' + this.options.speed + 'ms ' + this.options.easing );
				this.$el.css( '-ms-transition', 'all ' + this.options.speed + 'ms ' + this.options.easing );
