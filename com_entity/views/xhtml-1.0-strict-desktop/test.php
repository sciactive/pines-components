...
test, it is not considered to be a compatible entity manager. Please note that
this test does not test all aspects of an entity manager, and even if it passes,
...
<?php } else { ?>
<div style="font-family: monospace; margin-left: 35px;">Test is starting...
<ol>
...
<li style="white-space: pre;">Retrieving entity by tags and data...    <span style="color: <? echo ($this->tests[18]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[18]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Testing wrong tags and right data...     <span style="color: <? echo ($this->tests[19]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[19]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Testing right tags and wrong data...     <span style="color: <? echo ($this->tests[20]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[20]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Testing wrong tags and wrong data...     <span style="color: <? echo ($this->tests[21]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[21]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Deleting entity...                       <span style="color: <? echo ($this->tests[22]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[22]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Resaving entity...                       <span style="color: <? echo ($this->tests[23]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[23]) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Deleting entity by GUID...               <span style="color: <? echo ($this->tests[24]) ? 'green' : 'red'; ?>;">[<? echo ($this->tests[24]) ? 'PASS' : 'FAIL'; ?>]</span></li>
</ol>
