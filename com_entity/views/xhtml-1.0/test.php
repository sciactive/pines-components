...
<li style="white-space: pre;">Retrieving entity by regex match...      <span style="color: <? echo ($this->tests['match']) ? 'green' : 'red'; ?>;">[<? echo ($this->tests['match']) ? 'PASS' : 'FAIL'; ?>]</span></li>
<li style="white-space: pre;">Testing wrong regex match...             <span style="color: <? echo ($this->tests['wr_match']) ? 'green' : 'red'; ?>;">[<? echo ($this->tests['wr_match']) ? 'PASS' : 'FAIL'; ?>]</span></li>
