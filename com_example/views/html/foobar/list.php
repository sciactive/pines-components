...
if (isset($_SESSION['user']) && is_array($_SESSION['user']->pgrid_saved_states))
	$this->pgrid_state = (object) json_decode($_SESSION['user']->pgrid_saved_states['com_example/foobar/list']);
?>
	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_state_change: function(state) {
				...
				state_xhr = $.post(<?php echo json_encode(pines_url('com_pgrid', 'save_state')); ?>, {view: "com_example/foobar/list", state: cur_state});
			}
		};
...
<table id="p_muid_grid">
	...
	<?php foreach($this->foobars as $foobar) { ?>
		<tr title="<?php echo htmlspecialchars($foobar->guid); ?>">
			<td><a data-entity="<?php echo htmlspecialchars($foobar->guid); ?>" data-entity-context="com_example_foobar"><?php echo htmlspecialchars($foobar->name); ?></a></td>
