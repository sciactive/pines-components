	...
	<div class="pf-element">
		<label><span class="pf-label">Foobar</span>
			<select class="pf-field" name="id">
				...
				<option value="<?php echo htmlspecialchars($cur_foobar->guid); ?>"<?php echo $this->id == "$cur_foobar->guid" ? ' selected="selected"' : ''; ?>><?php echo htmlspecialchars($cur_foobar->name); ?></option>
				<?php } ?>
			</select></label>
	</div>
</div>