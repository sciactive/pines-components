...
<form class="pform" method="post" id="widget_details" action="<?php echo pines_url('com_example', 'savewidget'); ?>">
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="window.location='<?php echo pines_url('com_example', 'listwidgets'); ?>';" value="Cancel" />
	</div>
</form>