...
if(e[a._id])e[a._id].push(b);else e[a._id]=[b]},_clearEvents:function(){this.eventElements=[];this.eventElementsByID={}},showEvents:function(a,b){this._eee(a,b,"show")},hideEvents:function(a,b){this._eee(a,b,"hide")},_eee:function(a,b,e){a=this.eventElementsByID[a._id];var c,h=a.length;for(c=0;c<h;c++)a[c][0]!=b[0]&&a[c][e]()},eventDrop:function(a,b,e,c,h,l,j){var F=this,E=b.allDay,s=b._id;if(b.allDay==h)h=null;F.moveEvents(F.eventsByID[s],e,c,h);F.trigger("eventDrop",a,b,e,c,h,function(){F.moveEvents(F.eventsByID[s],
-e,-c,E);F.rerenderEvents()},l,j);F.eventsChanged=true;F.rerenderEvents(s)},eventResize:function(a,b,e,c,h,l){var j=this,F=b._id;j.elongateEvents(j.eventsByID[F],e,c);j.trigger("eventResize",a,b,e,c,function(){j.elongateEvents(j.eventsByID[F],-e,-c);j.rerenderEvents()},h,l);j.eventsChanged=true;j.rerenderEvents(F)},moveEvents:function(a,b,e,c){e=e||0;for(var h,l=a.length,j=0;j<l;j++){h=a[j];if(c!==J&&c!==null)h.allDay=c;da(D(h.start,b,true),e);if(h.end)h.end=da(D(h.end,b,true),e);Ha(h,this.options)}},
elongateEvents:function(a,b,e){e=e||0;for(var c,h=a.length,l=0;l<h;l++){c=a[l];c.end=da(D(this.eventEnd(c),b,true),e);Ha(c,this.options)}},renderOverlay:function(a,b){var e=this.unusedOverlays.shift();e||(e=m("<div class='fc-cell-overlay' style='position:absolute;z-index:3'/>"));e[0].parentNode!=b[0]&&e.appendTo(b);this.usedOverlays.push(e.css(a).show());return e},clearOverlays:function(){for(var a;a=this.usedOverlays.shift();)this.unusedOverlays.push(a.hide().unbind())},resizableDayEvent:function(a,
b,e){var c=this;if(!c.options.disableResizing&&b.resizable)b.resizable({handles:c.options.isRTL?{w:"div.ui-resizable-w"}:{e:"div.ui-resizable-e"},grid:e,minWidth:e/2,containment:c.element.parent().parent(),start:function(h,l){b.css("z-index",9);c.hideEvents(a,b);c.trigger("eventResizeStart",this,a,h,l)},stop:function(h,l){c.trigger("eventResizeStop",this,a,h,l);var j=Math.round((b.width()-l.originalSize.width)/e);if(j)c.eventResize(this,a,j,0,h,l);else{b.css("z-index",8);c.showEvents(a,b)}}})},eventElementHandlers:function(a,
b){var e=this;b.click(function(c){if(!b.hasClass("ui-draggable-dragging")&&!b.hasClass("ui-resizable-resizing"))return e.trigger("eventClick",this,a,c)}).hover(function(c){e.trigger("eventMouseover",this,a,c)},function(c){e.trigger("eventMouseout",this,a,c)})},option:function(a,b){a=this.options[a];if(typeof a=="object")return kb(a,b||this.name);return a},sliceSegs:function(a,b,e,c){var h=[],l,j=a.length,F,E,s,I,B;for(l=0;l<j;l++){F=a[l];E=F.start;s=b[l];if(s>e&&E<c){if(E<e){E=o(e);I=false}else{E=
E;I=true}if(s>c){s=o(c);B=false}else{s=s;B=true}h.push({event:F,start:E,end:s,isStart:I,isEnd:B,msLength:s-E})}}return h.sort(Gb)}},Bb=864E5,Ib=36E5,Fb=6E4;ya.addDays=D;ya.cloneDate=o;var lb=ya.parseDate=function(a){if(typeof a=="object")return a;if(typeof a=="number")return new Date(a*1E3);if(typeof a=="string"){if(a.match(/^\d+$/))return new Date(parseInt(a)*1E3);return Nb(a,true)||(a?new Date(a):null)}return null},Nb=ya.parseISO8601=function(a,b){a=a.match(/^([0-9]{4})(-([0-9]{2})(-([0-9]{2})([T ]([0-9]{2}):([0-9]{2})(:([0-9]{2})(\.([0-9]+))?)?(Z|(([-+])([0-9]{2}):([0-9]{2})))?)?)?)?$/);
