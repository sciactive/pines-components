...
?>
<form class="pform" method="post" id="employee_details" action="<?php echo pines_url('com_hrm', 'saveemployee'); ?>">
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="window.location='<?php echo pines_url('com_hrm', 'listemployees'); ?>';" value="Cancel" />
	</div>
</form>