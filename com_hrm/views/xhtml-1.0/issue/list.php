...
<div id="p_muid_issue_dialog" title="Employee Conduct Issue" style="display: none;">
	<form class="pf-form" method="post" action="">
		...
		<div class="pf-element">
			<label><span class="pf-label">Penalty</span>
				<span class="pf-field">$ <input class="ui-widget-content ui-corner-all" type="text" size="5" name="penalty" /></span></label>
		</div>
	</form>
	<br />
</div>