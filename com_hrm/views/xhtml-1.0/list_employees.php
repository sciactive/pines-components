	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'New', extra_class: 'picon picon_16x16_list-add-user', selection_optional: true, url: '<?php echo pines_url('com_hrm', 'editemployee'); ?>'},
				<?php } if (gatekeeper('com_sales/editemployee')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'picon picon_16x16_user-properties', double_click: true, url: '<?php echo pines_url('com_hrm', 'editemployee', array('id' => '__title__')); ?>'},
				<?php } ?>
				...
				{type: 'button', text: 'Delete', extra_class: 'picon picon_16x16_list-remove-user', confirm: true, multi_select: true, url: '<?php echo pines_url('com_hrm', 'deleteemployee', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
				<?php } ?>
