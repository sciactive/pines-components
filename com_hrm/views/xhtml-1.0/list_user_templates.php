	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'New', extra_class: 'icon picon_16x16_document-new', selection_optional: true, url: '<?php echo pines_url('com_hrm', 'editusertemplate'); ?>'},
				<?php } if (gatekeeper('com_sales/editusertemplate')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'icon picon_16x16_document-open', double_click: true, url: '<?php echo pines_url('com_hrm', 'editusertemplate', array('id' => '__title__')); ?>'},
				<?php } ?>
				{type: 'separator'},
				<?php if (gatekeeper('com_sales/deleteusertemplate')) { ?>
				{type: 'button', text: 'Delete', extra_class: 'icon picon_16x16_edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_hrm', 'deleteusertemplate', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
				<?php } ?>
