...
<form class="pf-form" method="post" id="p_muid_form" action="">
	...
	<div class="pf-element pf-full-width">
		<span class="pf-note">Start</span><input class="ui-widget-content form_center" type="text" id="p_muid_start" name="start" value="<?php echo empty($start_date) ? format_date(time(), 'date_sort') : $start_date; ?>" />
	...
	<div class="pf-element">
		<span class="pf-note">End</span><input class="ui-widget-content form_center" type="text" id="p_muid_end" name="end" value="<?php echo empty($end_date) ? format_date(time(), 'date_sort') : $end_date; ?>" />
