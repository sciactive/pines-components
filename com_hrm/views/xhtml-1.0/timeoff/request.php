...
<form class="pf-form" method="post" id="p_muid_form" action="">
	<div class="pf-element">
		<span class="pf-note">Reason for Time Off</span><input class="ui-widget-content form_input" type="text" id="p_muid_reason" name="reason" value="<?php echo htmlentities($this->entity->reason); ?>" />
	</div>
	<?php
		if ($this->entity->guid) {
