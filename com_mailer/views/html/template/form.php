	...
	<div id="p_muid_template_tabs" class="tab-content">
		<div class="tab-pane active" id="p_muid_tab_general">
			...
			<div class="pf-element pf-full-width">
				...
				<div class="pf-group">
					<div class="pf-field">
						<p>Macros let you replace a string with a value that can change. To use them, insert the desired macro string into the content where you would like the macro to appear.</p>
