	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				{type: 'button', text: 'New', extra_class: 'icon picon_16x16_document-new', selection_optional: true, url: '<?php echo pines_url('com_newsletter', 'new'); ?>'},
				{type: 'button', text: 'Edit', extra_class: 'icon picon_16x16_document-open', double_click: true, url: '<?php echo pines_url('com_newsletter', 'edit', array('mail_id' => '__title__')); ?>'},
				{type: 'button', text: 'Send', extra_class: 'icon picon_16x16_mail-message-new', url: '<?php echo pines_url('com_newsletter', 'sendprep', array('mail_id' => '__title__')); ?>'},
				{type: 'separator'},
				{type: 'button', text: 'Delete', extra_class: 'icon picon_16x16_edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_newsletter', 'delete', array('mail_id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
