	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				{type: 'button', text: 'New', extra_class: 'picon picon_16x16_document-new', selection_optional: true, url: '<?php echo pines_url('com_packager', 'editpackage'); ?>'},
				{type: 'button', text: 'Edit', extra_class: 'picon picon_16x16_document-edit', double_click: true, url: '<?php echo pines_url('com_packager', 'editpackage', array('id' => '__title__')); ?>'},
				{type: 'button', text: 'Make Package', extra_class: 'picon picon_16x16_package-x-generic', url: '<?php echo pines_url('com_packager', 'makepackage', array('id' => '__title__')); ?>'},
				//{type: 'button', text: 'E-Mail', extra_class: 'picon picon_16x16_mail-message-new', multi_select: true, url: 'mailto:__col_2__', delimiter: ','},
				{type: 'separator'},
				{type: 'button', text: 'Delete', extra_class: 'picon picon_16x16_edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_packager', 'deletepackage', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
