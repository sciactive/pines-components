...
<div class="pf-form" id="p_muid_package_result">
	...
	<div class="pf-element">
		<span class="pf-label">Package Files</span>
		<div class="pf-group">
			<span class="pf-field">The filename which your package was attempted to be created with is "<?php echo htmlspecialchars($this->path); ?>". If you don't have access to this path, try to gain access to it and attempt packaging again.</span>
		</div>
	</div>
	<div class="pf-element">
		<span class="pf-label">Package Again</span>
		<div class="pf-group">
			<span class="pf-field">You can attempt to <a href="<?php echo htmlspecialchars(pines_url('com_packager', 'makepackage', array('id' => $this->entity->guid))); ?>">create the package again</a>.</span>
		</div>
	</div>
	<?php } ?>
</div>