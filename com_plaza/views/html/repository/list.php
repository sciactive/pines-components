	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				{type: 'button', text: 'New', extra_class: 'picon picon-document-new', selection_optional: true, url: <?php echo json_encode(pines_url('com_plaza', 'repository/new')); ?>},
				{type: 'separator'},
				{type: 'button', text: 'Delete', extra_class: 'picon picon-edit-delete', confirm: true, multi_select: true, url: <?php echo json_encode(pines_url('com_plaza', 'repository/delete', array('id' => '__title__'))); ?>, delimiter: ','},
				{type: 'separator'},
			...
			pgrid_state_change: function(state) {
				...
				state_xhr = $.post(<?php echo json_encode(pines_url('com_pgrid', 'save_state')); ?>, {view: "com_plaza/repository/list", state: cur_state});
			}
		};
