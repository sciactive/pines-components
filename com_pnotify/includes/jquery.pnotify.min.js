...
"onmouseup"))},click:function(b){a.pnotify_nonblock&&(b.stopPropagation(),o(b,"onclick"))},dblclick:function(b){a.pnotify_nonblock&&(b.stopPropagation(),o(b,"ondblclick"))}});b.opts=a;if(a.pnotify_shadow&&!d.browser.msie)b.shadow_container=d("<div />",{"class":"ui-widget-shadow ui-pnotify-shadow"}).prependTo(b),a.pnotify_cornerclass!=""&&b.shadow_container.addClass(a.pnotify_cornerclass);b.container=d("<div />",{"class":"ui-widget ui-widget-content ui-pnotify-container "+(a.pnotify_type=="error"?
"ui-state-error":a.pnotify_type=="info"?"":"ui-state-highlight")}).appendTo(b);a.pnotify_cornerclass!=""&&b.container.addClass(a.pnotify_cornerclass);b.pnotify_version="1.1.1dev";b.pnotify=function(k){var c=a;typeof k=="string"?a.pnotify_text=k:a=d.extend({},a,k);b.opts=a;if(a.pnotify_shadow!=c.pnotify_shadow)a.pnotify_shadow&&!d.browser.msie?b.shadow_container=d("<div />",{"class":"ui-widget-shadow ui-pnotify-shadow"}).prependTo(b):b.children(".ui-pnotify-shadow").remove();a.pnotify_addclass===false?
b.removeClass(c.pnotify_addclass):a.pnotify_addclass!==c.pnotify_addclass&&b.removeClass(c.pnotify_addclass).addClass(a.pnotify_addclass);a.pnotify_title===false?b.title_container.hide("fast"):a.pnotify_title!==c.pnotify_title&&(a.pnotify_title_escape?b.title_container.text(a.pnotify_title).show(200):b.title_container.html(a.pnotify_title).show(200));a.pnotify_text===false?b.text_container.hide("fast"):a.pnotify_text!==c.pnotify_text&&(a.pnotify_text_escape?b.text_container.text(a.pnotify_text).show(200):
...
"bottom";break;case "left":g="right";break;case "right":g="left"}d=parseInt(b.css(g));isNaN(d)&&(d=0);if(typeof c.firstpos2=="undefined")c.firstpos2=d,c.nextpos2=c.firstpos2;if(c.dir1=="down"&&c.nextpos1+b.height()>m.height()||c.dir1=="up"&&c.nextpos1+b.height()>m.height()||c.dir1=="left"&&c.nextpos1+b.width()>m.width()||c.dir1=="right"&&c.nextpos1+b.width()>m.width())c.nextpos1=c.firstpos1,c.nextpos2+=c.addpos2+(typeof c.spacing2=="undefined"?10:c.spacing2),c.addpos2=0;if(c.animation&&c.nextpos2<
...
typeof a.pnotify_min_height=="string"&&b.container.css("min-height",a.pnotify_min_height);b.pnotify_history=a.pnotify_history;b.pnotify_hide=a.pnotify_hide;var g=i.data("pnotify");if(g==null||typeof g!="object")g=[];g=a.pnotify_stack.push=="top"?d.merge([b],g):d.merge(g,[b]);i.data("pnotify",g);a.pnotify_stack.push=="top"&&b.pnotify_queue_position(1);a.pnotify_after_init&&a.pnotify_after_init(b);if(a.pnotify_history){var l=i.data("pnotify_history");typeof l=="undefined"&&(l=d("<div />",{"class":"ui-pnotify-history-container ui-state-default ui-corner-bottom",
...
this.pnotify_display())});return false}})).append(d("<button />",{"class":"ui-pnotify-history-last ui-state-default ui-corner-all",text:"Last",mouseenter:function(){d(this).addClass("ui-state-hover")},mouseleave:function(){d(this).removeClass("ui-state-hover")},click:function(){var a=-1,b;do{b=a==-1?g.slice(a):g.slice(a,a+1);if(!b[0])break;a--}while(!b[0].pnotify_history||b[0].is(":visible"));if(!b[0])return false;b[0].pnotify_display&&b[0].pnotify_display();return false}})).appendTo(i),p=d("<span />",
{"class":"ui-pnotify-history-pulldown ui-icon ui-icon-grip-dotted-horizontal",mouseenter:function(){l.animate({top:"0"},{duration:100,queue:false})}}).appendTo(l).offset().top+2,l.css({top:"-"+p+"px"}),i.data("pnotify_history",l))}a.pnotify_stack.animation=false;b.pnotify_display();return b}});var q=/^on/,r=/^(dbl)?click$|^mouse(move|down|up|over|out|enter|leave)$|^contextmenu$/,s=/^(focus|blur|select|change|reset)$|^key(press|down|up)$/,t=/^(scroll|resize|(un)?load|abort|error)$/,n=function(e,f){var a,
e=e.toLowerCase();document.createEvent&&this.dispatchEvent?(e=e.replace(q,""),e.match(r)?(d(this).offset(),a=document.createEvent("MouseEvents"),a.initMouseEvent(e,f.bubbles,f.cancelable,f.view,f.detail,f.screenX,f.screenY,f.clientX,f.clientY,f.ctrlKey,f.altKey,f.shiftKey,f.metaKey,f.button,f.relatedTarget)):e.match(s)?(a=document.createEvent("UIEvents"),a.initUIEvent(e,f.bubbles,f.cancelable,f.view,f.detail)):e.match(t)&&(a=document.createEvent("HTMLEvents"),a.initEvent(e,f.bubbles,f.cancelable)),
a&&this.dispatchEvent(a)):(e.match(q)||(e="on"+e),a=document.createEventObject(f),this.fireEvent(e,a))};d.pnotify.defaults={pnotify_title:false,pnotify_title_escape:false,pnotify_text:false,pnotify_text_escape:false,pnotify_addclass:"",pnotify_cornerclass:"ui-corner-all",pnotify_nonblock:false,pnotify_nonblock_opacity:0.2,pnotify_history:true,pnotify_width:"300px",pnotify_min_height:"16px",pnotify_type:"notice",pnotify_notice_icon:"ui-icon ui-icon-info",pnotify_info_icon:"ui-icon ui-icon-info",pnotify_error_icon:"ui-icon ui-icon-alert",
