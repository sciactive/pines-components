...
if ( !gatekeeper('com_reports/summarizeemployees') )
	punt_user(null, pines_url('com_reports', 'employeesummary'));
...
$pines->com_reports->employee_summary($start_date, $end_date, $location, $descendants);
