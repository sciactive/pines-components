<?php
/**
 * List all sales, returns and voids.
 *
...
if ( !gatekeeper('com_reports/summarizeinvoices') )
	punt_user(null, pines_url('com_reports', 'invoicesummary'));
...
$pines->com_reports->invoice_summary($start_date, $end_date, $location, $descendants);
