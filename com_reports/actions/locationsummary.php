...
if ( !gatekeeper('com_reports/summarizelocations') )
	punt_user(null, pines_url('com_reports', 'locationsummary'));
...
$pines->com_reports->location_summary($start_date, $end_date, $location, $descendants);
