...
if ( !gatekeeper('com_reports/reportcalendar') )
	punt_user(null, pines_url('com_reports', 'reportcalendar'));
...
$pines->com_reports->report_calendar($start_date, $end_date, $location, $descendents);
