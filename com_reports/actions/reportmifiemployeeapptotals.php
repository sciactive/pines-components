<?php
/**
 * List all sales totals for employees.
 *
 * @package Pines
...
//$verbose = ($_REQUEST['verbose'] == 'true');

$pines->com_reports->report_mifi_employee_app_totals($start_date, $end_date, $location, $descendents);
