<?php
/**
 * List warehouse sale item information.
 *
 * @package Pines
...
if ( !gatekeeper('com_reports/reportwarehouse') )
	punt_user(null, pines_url('com_reports', 'reportwarehouse'));
...
$pines->com_reports->report_warehouse($start_date, $end_date, $location, $descendents);
?>