<?php
/**
 * Shows a list of all sales for employees in a given date range and location.
 *
 * @package Pines
...
<script type="text/javascript">
	...
	pines(function(){
		var search_mifi = function(){
			...
			pines.get("<?php echo addslashes(pines_url('com_reports', 'reportmifiemployeeapptotals')); ?>", {
				"location": location,
	...
	<table id="p_muid_grid">
		...
		<tbody>
			...
			<tr title="<?php echo (int) $key;?>">
				...
				<?php /* possibly add this later : <td><a href="<?php echo htmlspecialchars(pines_url('com_user', 'editgroup', array('id' => $value['group_guid']))); ?>" onclick="window.open(this.href); return false;"><?php echo htmlspecialchars($value['group_name']); ?></a></td>	*/?>
			</tr>
			<?php }?>
		</tbody>
	</table>
