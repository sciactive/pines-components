	...
	pines(function(){
		...
		var payroll_grid = $("#p_muid_grid").pgrid({
			...
			pgrid_toolbar_contents: [
				...
				{type: 'separator'},
				{type: 'button', text: 'Individual', extra_class: 'picon picon-document-print-preview', double_click: true, target: '_blank', url: '<?php echo addslashes(pines_url('com_reports', 'reportindividualpayroll', array('id' => '__title__','salary'=>'__col_3__','commission'=>'__col_12__','payperhour'=>'__col_22__','total' =>'__col_18__','hours' => '__col_8__', 'end_date' => format_date($this->end_date - 1, 'date_sort'), 'start_date' => format_date($this->start_date, 'date_sort'), 'template' => 'tpl_print'))); ?>'},
				{type: 'button', text: 'Multiple', extra_class: 'picon picon-document-print-preview', multi_select: true, target: '_blank', url: '<?php echo addslashes(pines_url('com_reports', 'reportmultiplepayroll', array('id' => '__title__','salary'=>'__col_3__','commission'=>'__col_12__','payperhour'=>'__col_22__','total' =>'__col_18__','hours' => '__col_8__', 'end_date' => format_date($this->end_date - 1, 'date_sort'), 'start_date' => format_date($this->start_date, 'date_sort'), 'template' => 'tpl_print'))); ?>', delimiter: ";"},
				{type: 'separator'},
