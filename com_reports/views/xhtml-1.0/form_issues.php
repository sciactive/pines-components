<?php
/**
 * Display a form to view employee issues reports.
 *
 * @package Pines
...
<form class="pf-form" method="post" id="p_muid_form" action="<?php echo htmlspecialchars(pines_url('com_reports', 'reportissues')); ?>">
	...
	<div class="pf-element" style="padding-bottom: 0px;">
		...
		<input class="pf-field ui-widget-content ui-corner-all form_date" type="text" name="start" value="<?php echo ($this->date[0]) ? format_date($this->date[0], 'date_sort') : format_date(time(), 'date_sort'); ?>" />
	</div>
	<div class="pf-element">
		<span class="pf-note">End</span>
		<input class="pf-field ui-widget-content ui-corner-all form_date" type="text" name="end" value="<?php echo ($this->date[1]) ? format_date($this->date[1], 'date_sort') : format_date(time(), 'date_sort'); ?>" />
	</div>
	<div class="pf-element">
