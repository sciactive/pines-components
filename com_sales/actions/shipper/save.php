...
if ( isset($_REQUEST['id']) ) {
	if ( !gatekeeper('com_sales/editshipper') )
		punt_user('You don\'t have necessary permission.', pines_url('com_sales', 'shipper/list'));
...
$test = $pines->entity_manager->get_entity(array('class' => com_sales_shipper), array('&', 'data' => array('name', $shipper->name), 'tag' => array('com_sales', 'shipper')));
...
redirect(pines_url('com_sales', 'shipper/list'));
