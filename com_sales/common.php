...
$config->ability_manager->add('com_sales', 'listsales', 'List Sales', 'User can see sales.');
...
$config->ability_manager->add('com_sales', 'listmanufacturers', 'List Manufacturers', 'User can see manufacturers.');
...
$config->ability_manager->add('com_sales', 'listvendors', 'List Vendors', 'User can see vendors.');
...
$config->ability_manager->add('com_sales', 'listshippers', 'List Shippers', 'User can see shippers.');
...
$config->ability_manager->add('com_sales', 'listtaxfees', 'List Taxes/Fees', 'User can see taxes/fees.');
...
$config->ability_manager->add('com_sales', 'listpaymenttypes', 'List Payment Types', 'User can see payment types.');
...
$config->ability_manager->add('com_sales', 'listproducts', 'List Products', 'User can see products.');
...
$config->ability_manager->add('com_sales', 'listpos', 'List Purchase Orders', 'User can see POs.');
