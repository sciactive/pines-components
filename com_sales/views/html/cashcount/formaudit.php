...
<script type="text/javascript">
	...
	pines(function(){
		...
		var update_total = function(){
			...
			$("#p_muid_total_audit").html(pines.safe(cash_symbol+total_count.toFixed(2)));
		};
...
<form class="pf-form" method="post" id="p_muid_form" action="<?php echo htmlspecialchars(pines_url('com_sales', 'cashcount/saveaudit')); ?>">
