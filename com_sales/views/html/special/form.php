	...
	<script type="text/javascript">
		pines(function(){
			...
			var discounts = $("#p_muid_form [name=discounts]"),
				discounts_table = $("#p_muid_form .discounts_table"),
				discount_dialog = $("#p_muid_form .discount_dialog"),
				cur_discount = null;
			...
			var requirements = $("#p_muid_form [name=requirements]"),
				requirements_table = $("#p_muid_form .requirements_table"),
				requirement_dialog = $("#p_muid_form .requirement_dialog"),
