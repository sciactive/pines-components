...
<form class="pf-form" method="post" id="p_muid_form" action="<?php echo htmlentities(pines_url('com_sales', 'cashcount/save')); ?>">
	...
	<div class="pf-element pf-full-width" style="position: relative;">
		...
		<div class="pf-element">
			<input class="pf-field ui-widget-content entry" type="text" name="count_<?php echo $cur_denom; ?>" value="<?php echo (int) $this->entity->count[$cur_denom]; ?>" <?php echo $this->entity->final ? 'readonly="readonly"' : ''; ?>/>
