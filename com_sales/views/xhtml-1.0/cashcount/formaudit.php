...
<script type="text/javascript">
	...
	pines(function(){
		...
		var update_total = function(){
			...
			$("#p_muid_total_audit").html(cash_symbol+total_count.toFixed(2));
		};
...
<form class="pf-form" method="post" id="p_muid_form" action="<?php echo htmlentities(pines_url('com_sales', 'cashcount/saveaudit')); ?>">
	...
	<?php } ?>
	<div class="pf-element pf-heading">
		<h1>Cash Drawer Contents<button class="ui-state-default ui-corner-all" type="button" name="clear_btn" onclick="pines.com_sales_clear_all()" style="margin-left: 50px;"><span>Clear All</span></button></h1>
	</div>
	<div class="pf-group">
		<div>
		...
		<div>
			<div class="total ui-corner-all">
				...
				<span id="p_muid_total_audit"></span>
			</div>
		</div>
	</div>
	<div class="pf-element pf-heading">
	...
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button ui-state-default ui-priority-primary ui-corner-all" type="button" value="Finish Audit" onclick="pines.com_sales_verify();" />
