	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_state_change: function(state) {
				...
				state_xhr = $.post("<?php echo pines_url('com_pgrid', 'save_state'); ?>", {view: "com_sales/form_cashcount_review", state: cur_state});
			}
		};
...
<form class="pf-form" method="post" id="cashcount_details" action="<?php echo pines_url('com_sales', 'savecashcountstatus'); ?>">
	...
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo pines_url('com_sales', 'listcashcounts'); ?>');" value="Cancel" />
	</div>
</form>