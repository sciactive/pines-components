...
$this->note = 'Only use this form to receive inventory into your <strong>current</strong> location ('.(is_null($_SESSION['user']->gid) ? 'No Location' : $config->user_manager->get_groupname($_SESSION['user']->gid)).').';
?>
