	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'New', extra_class: 'picon picon-document-new', selection_optional: true, url: '<?php echo pines_url('com_sales', 'editcashcount'); ?>'},
				<?php } if (gatekeeper('com_sales/editcashcount')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'picon picon-document-edit', double_click: true, url: '<?php echo pines_url('com_sales', 'editcashcount', array('id' => '__title__')); ?>'},
				<?php } if (gatekeeper('com_sales/skimcashcount')) { ?>
				{type: 'button', text: 'Skim', extra_class: 'picon picon-list-remove', url: '<?php echo pines_url('com_sales', 'skimcashcount', array('id' => '__title__')); ?>'},
				<?php } if (gatekeeper('com_sales/depositcashcount')) { ?>
				{type: 'button', text: 'Deposit', extra_class: 'picon picon-list-add', url: '<?php echo pines_url('com_sales', 'depositcashcount', array('id' => '__title__')); ?>'},
				<?php } if (gatekeeper('com_sales/auditcashcount')) { ?>
				{type: 'button', text: 'Audit', extra_class: 'picon picon-document-edit-verify', url: '<?php echo pines_url('com_sales', 'auditcashcount', array('id' => '__title__')); ?>'},
				<?php }if (gatekeeper('com_sales/approvecashcount')) { ?>
				{type: 'button', text: 'Review', extra_class: 'picon picon-checkbox', url: '<?php echo pines_url('com_sales', 'approvecashcount', array('id' => '__title__')); ?>'},
				...
				{type: 'button', text: 'Delete', extra_class: 'picon picon-edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_sales', 'deletecashcount', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
				<?php } ?>
