	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'Receive', extra_class: 'picon picon_16x16_document-new', selection_optional: true, url: '<?php echo pines_url('com_sales', 'receive'); ?>'},
				<?php } if (gatekeeper('com_sales/managestock')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'picon picon_16x16_document-edit', double_click: true, url: '<?php echo pines_url('com_sales', 'editstock', array('id' => '__title__')); ?>'},
				<?php } if (gatekeeper('com_sales/managestock')) { ?>
				{type: 'button', text: 'Transfer', extra_class: 'picon picon_16x16_go-jump', multi_select: true, url: '<?php echo pines_url('com_sales', 'newtransfer', array('id' => '__title__')); ?>', delimiter: ','},
				<?php } ?>
