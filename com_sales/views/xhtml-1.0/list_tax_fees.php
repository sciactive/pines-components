    ...
    $(document).ready(function(){
        ...
        var cur_defaults = {
            ...
            pgrid_toolbar_contents: [
                {type: 'button', text: 'New', extra_class: 'icon picon_16x16_actions_document-new', selection_optional: true, url: '<?php echo pines_url('com_sales', 'newtaxfee'); ?>'},
            ...
            pgrid_state_change: function(state) {
                ...
                $.post("<?php echo pines_url('system', 'pgrid_save_state'); ?>", {view: "com_sales/list_tax_fees", state: cur_state});
            }
        };
