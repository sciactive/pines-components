...
<script type="text/javascript">
	...
	pines(function(){
		$("#p_muid_email").click(function(){
			pines.get("<?php echo pines_url('com_sales', 'sale/sendreceipt', array('id' => $this->entity->guid)); ?>");
		});
		$("#p_muid_print").click(function(){
			pines.get("<?php echo pines_url('com_sales', 'sale/printreceipt', array('id' => $this->entity->guid)); ?>");
		});
	});
	// ]]>
</script>
