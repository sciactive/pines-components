	...
	pines(function() {
		var options = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'Edit', extra_class: 'picon picon-document-edit', double_click: true, url: '<?php echo addslashes(pines_url('com_sales', 'product/edit', array('id' => '__title__'))); ?>', target: 'editing_stock'},
				<?php } ?>
				{type: 'separator'},
