...
$result = $pines->com_testimonials->get_testimonials($review_data_type, $review_option_reverse, $review_option_limit, $review_option_offset, $review_option_additional_tags, $review_entity_guid, $review_entity_class, $review_option_name);
