	...
	pines(function(){
		$("textarea.peditor").tinymce({
			...
			<?php switch ($pines->config->com_tinymce->features) {
				...
				default:
					?>
					plugins : "style,advhr,advimage,advlink,inlinepopups,insertdatetime,preview,media,searchreplace,contextmenu,paste,fullscreen,noneditable,visualchars,xhtmlxtras,advlist",
					// Theme options
