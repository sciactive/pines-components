...
$config->ability_manager->add('com_user', 'listusers', 'List Users', 'User can view user list.');
...
$config->ability_manager->add('com_user', 'listgroups', 'List Groups', 'User can view group list.');
