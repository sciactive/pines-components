...
$config->ability_manager->add('com_user', 'listusers', 'List Users', 'User can see users.');
...
$config->ability_manager->add('com_user', 'listgroups', 'List Groups', 'User can see groups.');
