	...
	pines(function(){
		...
		var cur_defaults = {
			...
			pgrid_toolbar_contents: [
				...
				{type: 'button', text: 'New', extra_class: 'picon picon_16x16_user-group-new', selection_optional: true, url: '<?php echo pines_url('com_user', 'editgroup'); ?>'},
				<?php } if (gatekeeper('com_sales/editgroup')) { ?>
				{type: 'button', text: 'Edit', extra_class: 'picon picon_16x16_user-group-properties', double_click: true, url: '<?php echo pines_url('com_user', 'editgroup', array('id' => '__title__')); ?>'},
				<?php } ?>
				...
				{type: 'button', text: 'Delete', extra_class: 'picon picon_16x16_user-group-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_user', 'deletegroup', array('id' => '__title__')); ?>', delimiter: ','},
				{type: 'separator'},
				<?php } ?>
