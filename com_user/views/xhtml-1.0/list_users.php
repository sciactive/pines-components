    ...
    $(document).ready(function(){
        ...
        var cur_defaults = {
            ...
            pgrid_toolbar_contents: [
                ...
                {type: 'button', text: 'Edit', extra_class: 'icon picon_16x16_actions_document-open', double_click: true, url: '<?php echo pines_url('com_user', 'edituser', array('user_id' => '#title#')); ?>'},
                ...
                {type: 'separator'},
                {type: 'button', text: 'Delete', extra_class: 'icon picon_16x16_actions_edit-delete', confirm: true, multi_select: true, url: '<?php echo pines_url('com_user', 'deleteuser', array('user_id' => '#title#')); ?>', delimiter: ','},
                {type: 'separator'},
            ...
            pgrid_state_change: function(state) {
                ...
                $.post("<?php echo pines_url('system', 'pgrid_save_state'); ?>", {view: "com_user/list_users", state: cur_state});
            }
        };
