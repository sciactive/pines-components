...
<form class="pform" method="post" id="user_template_details" action="<?php echo pines_url('com_hrm', 'saveusertemplate'); ?>">
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="window.location='<?php echo pines_url('com_hrm', 'listusertemplates'); ?>';" value="Cancel" />
	</div>
</form>