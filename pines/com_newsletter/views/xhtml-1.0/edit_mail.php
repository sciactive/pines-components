...
<form class="pform" enctype="multipart/form-data" name="editingmail" method="post" action="<?php echo htmlentities(pines_url($this->new_option, $this->new_action)); ?>">
	...
	<div class="element buttons" style="padding-left: 0;">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo htmlentities(pines_url($this->close_option, $this->close_action)); ?>');" value="Close" /> <small>(Closing will lose any unsaved changes!)</small>
	</div>
	<div class="element">
