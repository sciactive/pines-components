...
?>
<form class="pform" method="post" id="manufacturer_details" action="<?php echo htmlentities(pines_url('com_sales', 'savemanufacturer')); ?>">
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo htmlentities(pines_url('com_sales', 'listmanufacturers')); ?>');" value="Cancel" />
	</div>
</form>