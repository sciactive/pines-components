...
<form class="pf-form" method="post" id="shipper_details" action="<?php echo htmlentities(pines_url('com_sales', 'saveshipper')); ?>">
	...
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo htmlentities(pines_url('com_sales', 'listshippers')); ?>');" value="Cancel" />
	</div>
</form>