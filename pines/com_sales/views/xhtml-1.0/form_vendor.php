...
<form class="pform" method="post" id="vendor_details" action="<?php echo pines_url('com_sales', 'savevendor'); ?>">
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo pines_url('com_sales', 'listvendors'); ?>');" value="Cancel" />
	</div>
</form>