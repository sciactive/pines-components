...
?>
<form class="pform" method="post" id="vendor_details" action="<?php echo htmlentities(pines_url('com_sales', 'savevendor')); ?>">
	...
	<div class="element">
		...
		<input class="field ui-widget-content" type="text" name="state" size="2" value="<?php echo $this->entity->state; ?>" />
	</div>
	<div class="element">
	...
	<div class="element">
		<label><span class="label">Account #</span>
			<input class="field ui-widget-content" type="text" name="account_number" size="24" value="<?php echo $this->entity->account_number; ?>" /></label>
	</div>
	<br />
	<fieldset class="group">
		...
		<div class="element">
			<label><span class="label">Username</span>
				<input class="field ui-widget-content" type="text" name="client_username" size="24" value="<?php echo $this->entity->client_username; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Password</span>
				<input class="field ui-widget-content" type="text" name="client_password" size="24" value="<?php echo $this->entity->client_password; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Rep Name</span>
				<input class="field ui-widget-content" type="text" name="client_rep_name" size="24" value="<?php echo $this->entity->client_rep_name; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Email</span>
				<input class="field ui-widget-content" type="text" name="client_email" size="24" value="<?php echo $this->entity->client_email; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Web Address</span>
				<input class="field ui-widget-content" type="text" name="client_web_address" size="24" value="<?php echo $this->entity->client_web_address; ?>" /></label>
		</div>
		<br />
	</fieldset>
	<br />
	<fieldset class="group">
		...
		<div class="element">
			<label><span class="label">Web Address</span>
				<input class="field ui-widget-content" type="text" name="online_web_address" size="24" value="<?php echo $this->entity->online_web_address; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Customer ID</span>
				<input class="field ui-widget-content" type="text" name="online_customer_id" size="24" value="<?php echo $this->entity->online_customer_id; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Username</span>
				<input class="field ui-widget-content" type="text" name="online_username" size="24" value="<?php echo $this->entity->online_username; ?>" /></label>
		</div>
		<div class="element">
			<label><span class="label">Password</span>
				<input class="field ui-widget-content" type="text" name="online_password" size="24" value="<?php echo $this->entity->online_password; ?>" /></label>
		</div>
		<br />
	</fieldset>
	...
	<div class="element buttons">
		...
		<input class="button ui-state-default ui-priority-secondary ui-corner-all" type="button" onclick="pines.get('<?php echo htmlentities(pines_url('com_sales', 'listvendors')); ?>');" value="Cancel" />
	</div>
</form>