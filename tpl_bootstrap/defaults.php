...
return array(
	...
	array(
		'name' => 'load_css1',
		'cname' => 'JS Load Pines Relative CSS 1',
		'description' => 'You can add a pines relative style sheet to always load with this template. Uses JavaScript loading. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css2',
		'cname' => 'JS Load Pines Relative CSS 2',
	...
	array(
		'name' => 'load_css3',
		'cname' => 'JS Load Pines Relative CSS 3',
		'description' => 'You can add a pines relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css4',
		'cname' => 'JS Load Pines Relative CSS 4',
		'description' => 'You can add a pines relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	...
	array(
		'name' => 'load_js2',
		'cname' => 'Load Pines Relative JS 2',
		'description' => 'You can add a pines relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js3',
		'cname' => 'Load Pines Relative JS 3',
		'description' => 'You can add a pines relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
