...
return array(
	array(
		...
		'options' => array(
			...
			'fixed-noside (Fixed width, no sidebar.)' => 'fixed-noside',
			'fixed-full (Fixed width, no sidebar or padding.)' => 'fixed-full',
			'fluid-sideleft (Fluid width, left sidebar.)' => 'fluid-sideleft',
			'fluid-sideright (Fluid width, right sidebar.)' => 'fluid-sideright',
			'fluid-noside (Fluid width, no sidebar.)' => 'fluid-noside',
			'fluid-full (Fluid width, no sidebar or padding.)' => 'fluid-full',
		),
		'peruser' => true,
	),
	array(
